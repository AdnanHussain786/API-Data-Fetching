...
class YearlyPlanScreen extends StatefulWidget {
  const YearlyPlanScreen({super.key});

  @override
  State<YearlyPlanScreen> createState() => _YearlyPlanScreenState();
}

class _YearlyPlanScreenState extends State<YearlyPlanScreen> {
  int selected = 0;
