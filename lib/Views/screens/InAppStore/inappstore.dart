...
class InAppStoreScreen extends StatefulWidget {
  const InAppStoreScreen({Key? key});
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            buildListViewBuilder(bookData),
            SizedBox(
              height: 20.h,
            ),
            buildCategoryRow('Top Courses', courseData),
            buildListViewBuilder(courseData),
            SizedBox(
              height: 20.h,
            ),
            buildCategoryRow('Top Articles', articleData),
            buildListViewBuilder(articleData),
          ],
        ),
      ),
    );
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            decoration: BoxDecoration(
                color: MyCustomColors().kWhiteColor3,
